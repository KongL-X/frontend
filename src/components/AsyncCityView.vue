<template>
    ...
    <div class="max-w-screen-md w-full py-12">
        <div class="mx-8 text-white">
            <h2 class="mb-4"> 3 Hourly Weather</h2>
            <div class="flex gap-10 overflow-x-scroll">
                <div v-for="hourData in forecastData.list" 
                     :key="hourData.dt"
...
const getWeatherData =async () =>{
    ...
    try {
        const weatherData = await axios.get(`https://api.openweathermap.org/data/2.5/weather?lat=${route.query.lat}&lon=${route.query.lon}&appid=${KeyAPI}&units=imperial`);
        const forecastData =await axios.get(`https://api.openweathermap.org/data/2.5/forecast?lat=${route.query.lat}&lon=${route.query.lon}&appid=${KeyAPI}&units=imperial`)
